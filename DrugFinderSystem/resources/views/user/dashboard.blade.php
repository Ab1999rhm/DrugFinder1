        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item position-relative">
                    <a class="nav-link {{ request()->routeIs('user.drugs.index') ? 'active' : '' }}"
                        href="{{ route('user.drugs.index') }}">
                ...
                <li class="nav-item position-relative">
                    <a class="nav-link {{ request()->routeIs('user.notifications') ? 'active' : '' }}"
                        ...
                        @if(!empty($newDrugsCount) && $newDrugsCount > 0)
                        <span class="notification-badge">{{ $newDrugsCount }}</span>
                        @endif
                    </a>
                </li>
            </ul>
...
<div class="hero-section">
    ...
    <a href="{{ route('user.drugs.index') }}" class="btn btn-primary btn-lg shadow">
...
<div class="dashboard-section">
    <div class="dashboard-cards">
        <a href="{{ route('user.orders.index') }}" class="dashboard-card">
            <i class="fas fa-clipboard-list"></i>
            <div>
                <div class="card-title">Order History</div>
                <div class="card-desc">See your recent and past orders.</div>
            </div>
        </a>
        <a href="{{ route('user.wishlist') }}" class="dashboard-card">
            ...
            <div>
                ...
                <div class="card-desc">View and manage your favorite drugs.</div>
            </div>
        </a>
        <a href="{{ route('user.notifications') }}" class="dashboard-card position-relative">
            ...
            <div>
                ...
                <div class="card-desc">Check new updates and alerts.</div>
            </div>
        </a>
        <a href="{{ route('user.pharmacies') }}" class="dashboard-card">
            <i class="fas fa-map-marker-alt"></i>
            <div>
                <div class="card-title">Nearby Pharmacies</div>
                <div class="card-desc">Find pharmacies near your location.</div>
            </div>
        </a>
    </div>
</div>
        ...
        <div class="row text-center text-md-start">
            ...
            <div class="col-md-4 mb-4">
                ...
                <div>
                    ...
                    <div class="faq-answer">You can email us at <a href="mailto:support@drugfinder.com">support@drugfinder.com</a> or call our hotline.</div>
